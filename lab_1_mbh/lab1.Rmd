...
shft cntrl c to comment/uncomment quickly
...
**Example 3:** Only keep Blackwood Acacia trees, and then only keep columns `legal_status`, `date`, `latitude`, `longitude`, and store as `blackwood_acacis_df`
